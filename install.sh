...
create_symlink "$DOTFILES_DIR/codex-cli/config.toml" "$HOME/.codex/config.toml"
...
create_symlink "$DOTFILES_DIR/agents/pi/keybindings.json" "$HOME/.pi/agent/keybindings.json"
